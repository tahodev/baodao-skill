...
2026-09-09 實測:HTTP 200、約 20KB、不需特殊 User-Agent。頁面含最新一期的「中獎號碼單」(當日為 115年03-04月,領獎期間自115年06月06日起至115年09月07日止),以及最新期別的特別獎、特獎中獎清冊連結。雲端發票專屬獎在 `cloudNowNumber.html`。
...
回報時附上:期別、中獎號碼、領獎期間、出處 URL。民國年 = 西元年 - 1911(例:115年 = 2026年)。
