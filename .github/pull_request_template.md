...
- [ ] SKILL.md 裡的指令與 URL 都已實際執行確認，並標明實測日期（YYYY-MM-DD 實測）
- [ ] 錯誤與失敗時的處理一節已更新（新技能一定要有）
- [ ] 外部數值（費率、數量、日期）標明基準日與出處 URL
- [ ] 繁體中文（台灣）優先，含 English summary
- [ ] `docs/features/<技能名>.md` 與 SKILL.md 同步
